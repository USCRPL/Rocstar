 ...
 *********************************************************************/
// $Id: MesqPane_1_1.h,v 1.3 2008/12/06 08:45:24 mtcampbe Exp $
/** \file MesqPane.h
 *   MesqPane.h
 *  
...
public:
  ...
  //! Invert Elements
  /**
   *  Either inverts tetrahedrons by swapping the 2nd
   *  and 4th nodes in each element.
   *  Or inverts hexahedrons by swapping the 2nd and 4th nodes
   *  as well as the 6th and 8th.
   */
